...
const Biz: React.FC<BizProps> = ({}) => {
  return (
    <div>
      <Titles scene="bizTitle">
        <h1 className="title">
          biz(<span className="params">2011,2019</span>)
        </h1>
      </Titles>

      <section className="scene" id="biz1">
        <div className="static-container">
          <div className="std">
            <p className="-big">
              For the past 8 years, I was the{" "}
              <b className="-purple">Head of Product Design and Frontend</b> at
              <Link href="https://www.bizcommerce.com.br/">
                <a target="_blank" title="Visit Biz Commerce's website">
                  biz
                </a>
              </Link>
              .
        ...
        <div className="container">
          ...
          >
            ...
            <desc id="aBizDesc">
              She is a cute light blue pentagon, holding the Magento logo inside
              an orange circle
            </desc>
          ...
          >
            <desc id="dinoDesc">
              A purple dinosaur with a red headset, listening and dancing to the
              music
            </desc>
          ...
          >
            <desc id="astroDesc">
              An astronaut in a purple space suit, floating in space trying to
              reach for his coffee cup
            </desc>
          ...
          >
            <desc id="filomenaDesc">
              A calm orange shrimp, with a smile on her face, swimming with her
              little legs
            </desc>
          ...
          >
            <desc id="octoDesc">
              A green one-eyed octopus, smiling and swimming around with his
              little tentacles
            </desc>
      ...
      <section className="scene" id="biz2">
        <div className="static-container">
          <div className="std">
            <p>
              Throughout these years we delivered over
              <span className="-big -purple">
                200 tools, modules, APIs, themes, and customized projects
              </span>
      ...
      <section className="scene" id="biz3">
        <div className="static-container">
          <div className="std">
            <p>
              biz currently runs on
              <span className="-big">
                <span className="-purple">600+ stores</span>, payment/shipping
                services and{" "}
                <span className="-purple">thousands of transactions</span>{" "}
                daily.
              </span>
            </p>
          </div>
